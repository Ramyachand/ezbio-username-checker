    ...
    try:
        while True:
            ...
            try:
                ...
                # Unclaimed kontrolü - "Page not found." metnini ara
                unclaimed_indicator = "page not found."
                
                # Eğer "Page not found." varsa unclaimed'dir
                is_unclaimed = unclaimed_indicator in page_text
                ...
                if is_unclaimed:
                    ...
                    if webhook_url:
                        embed = {
                            "title": f"Available: {random_suffix} (https://e-z.bio/{random_suffix})",
                            "description": f"github.com/efekrbas",
                            "color": 0x0000FF  # Mavi renk (konsol çıktısıyla aynı)
                        }
                        payload = {
                            "embeds": [embed]
                        }
                ...
                print(f"URL: {Fore.BLUE}{base_url}{random_suffix}{Fore.RESET} - Status: {status}{Fore.RESET}")
